...
module "starter_pack" {
  ...
  # Optional: specify the Gateway resource name if not using default "eg"
  gateway_name = "my-gateway"

  # Optional: specify the Gateway namespace if not using default "default"
...
|------|------|---------|-------------|
| `gateway_name` | string | `"eg"` | Name of the Gateway resource for the HTTPRoute to reference |
| `gateway_namespace` | string | `"default"` | Namespace of the Gateway resource for the HTTPRoute to reference |
